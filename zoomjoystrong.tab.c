...
{
       9,    -3,    -9,    -8,    -6,     1,     3,    10,     0,    -9,
      -9,    -9,    -9,    -9,    -9,    -9,    -9,    11,    12,    13,
      14,    15,    -9,    -9,    22,    17,    18,    19,    20,    -9,
      21,    28,    23,    30,    31,    -9,    32,    -9,    -9,    -9
};
...
{
      22,    16,    17,     2,    18,     3,     4,     5,     6,     7,
       1,    19,     2,    20,     3,     4,     5,     6,     7,     0,
...
static const yytype_int8 yystos[] =
{
      ...
      15,    16,    17,    18,    19,    20,     4,    10,    10,    10,
      10,    10,     0,    14,    10,    10,    10,    10,    10,     4,
...
#line 34 "zoomjoystrong.y"
                                        {yyerrok; }
#line 1332 "zoomjoystrong.tab.c"
    break;

  case 11:
#line 46 "zoomjoystrong.y"
                { 
		if(checkBounds((yyvsp[-2].i), (yyvsp[-1].i)) == 0)
...
#line 55 "zoomjoystrong.y"
                { 	
		if(checkBounds((yyvsp[-4].i), (yyvsp[-3].i)) == 0 && checkBounds((yyvsp[-2].i), (yyvsp[-1].i)) == 0)
...
#line 64 "zoomjoystrong.y"
                { 
		if(checkCircleBounds((yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i)))
...
#line 82 "zoomjoystrong.y"
                { 
		if(checkRGB((yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i)) == 0)
